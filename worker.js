  ...
  async fetch(request, env) {
    ...
    if (path === "/usgs") {
      ...
      const fetch1 = async (params) => {
        ...
        const r = await fetch(u, { headers:{"Accept":"application/json","User-Agent":"driftscout/1.0"}, cf:{cacheTtl:60,cacheEverything:true} });
    ...
    if (path === "/sites") {
      ...
      try {
        ...
        return new Response(await r.text(), { headers:{"Content-Type":"text/plain","Access-Control-Allow-Origin":"*","Cache-Control":"max-age=3600"} });
      } catch(e) {
